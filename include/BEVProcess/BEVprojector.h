...
class BEVProjector {
 public:
  ...
  inline int xMinIndex() const { return x_min_ind_; }
  inline int yMinIndex() const { return y_min_ind_; }
  // 可选：若需要做边界检查，可再暴露尺寸
  inline int xSize() const { return x_num_; }
  inline int ySize() const { return y_num_; }
